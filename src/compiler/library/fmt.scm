...
fmt-add-properties! fmt-bind fmt-capture fmt-col fmt-columns fmt-decimal-sep
fmt-file fmt-if fmt-join fmt-join/dot fmt-join/last fmt-join/prefix
fmt-join/range fmt-join/suffix fmt-let fmt-null fmt-port fmt-precision
fmt-properties fmt-radix fmt-ref fmt-row fmt-set! fmt-set-col!
fmt-set-decimal-sep! fmt-set-port! fmt-set-precision! fmt-set-properties!
fmt-set-property! fmt-set-radix! fmt-set-row!  fmt-set-width! fmt-set-writer!
fmt-start fmt-try-fit fmt-width fmt-writer fold-lines justify line-numbers
make-nl-space make-space make-string-fmt-transformer mantissa+exponent
maybe-slashified new-fmt-state nl nl-str num num/comma num/fit num/old-roman
num/roman num/si pad pad-char pad/both pad/left pad/right pretty
pretty/unshared radix slashified space-to tab-to tabular titlecase trim
trim/both trim/left trim/length upcase with-width wrap-lines write-to-string
wrt wrt/unshared)
...
(import foreign
        (except srfi-13 string-copy string-tokenize string-fill!
